...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "tests._stack_bench_c",
        "sources": [
            "tests/_stack_bench_c.pyx"
        ]
    },
    "module_name": "tests._stack_bench_c"
}
END: Cython Metadata */
...
#define __PYX_HAVE__tests___stack_bench_c
#define __PYX_HAVE_API__tests___stack_bench_c
/* Early includes */
#include <stdint.h>
#ifdef _OPENMP
#include <omp.h>
...
/*--- Type declarations ---*/
struct __pyx_obj_7imgcomp_8_stack_c_OpHandler;

/* "imgcomp/_stack_c.pxd":6
...
*/
typedef int (*__pyx_t_7imgcomp_8_stack_c_op_fn_t)(void);

/* "imgcomp/_stack_c.pxd":8
 * ctypedef int (*op_fn_t)() except -1
 * 
 * cdef class OpHandler:             # <<<<<<<<<<<<<<
 *     cdef op_fn_t fn
...
struct __pyx_obj_7imgcomp_8_stack_c_OpHandler {
  PyObject_HEAD
  __pyx_t_7imgcomp_8_stack_c_op_fn_t fn;
  int op_id;
  PyObject *name;
  int takes_operand;
  int is_body;
...
static int (*__pyx_f_7imgcomp_8_stack_c_data_push_int)(int64_t); /*proto*/
static int64_t (*__pyx_f_7imgcomp_8_stack_c_data_pop_int)(void); /*proto*/
static int (*__pyx_f_7imgcomp_8_stack_c_data_push_float)(double); /*proto*/
static double (*__pyx_f_7imgcomp_8_stack_c_data_pop_float)(void); /*proto*/

/* Module declarations from "tests._stack_bench_c" */
static int64_t __pyx_f_5tests_14_stack_bench_c_ack_c(int64_t, int64_t); /*proto*/
static int64_t __pyx_f_5tests_14_stack_bench_c_mandel_escape_iters(double, double, int); /*proto*/
static int64_t __pyx_f_5tests_14_stack_bench_c_mandel_sum_c(int, int, int); /*proto*/
static int64_t __pyx_f_5tests_14_stack_bench_c_int_step_sum_c(int64_t, int64_t, int64_t); /*proto*/
static double __pyx_f_5tests_14_stack_bench_c_float_step_sum_c(double, double, double); /*proto*/
static int __pyx_f_5tests_14_stack_bench_c__op_ack(void); /*proto*/
static int __pyx_f_5tests_14_stack_bench_c__op_mandel_pixel(void); /*proto*/
static int __pyx_f_5tests_14_stack_bench_c__op_mandel_sum(void); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "tests._stack_bench_c"
extern int __pyx_module_is_main_tests___stack_bench_c;
int __pyx_module_is_main_tests___stack_bench_c = 0;

/* Implementation of "tests._stack_bench_c" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
static const char __pyx_k_Test_only_C_kernels_and_VM_op_ha[] = "Test-only C kernels and VM op handlers for stack benchmarks.\n\nNative implementations used by ``tests.stack_bench``:\n\n- ``ack_native`` / ``ack`` opcode: Ackermann in C\n- ``mandel_escape_iters`` (internal): one Mandelbrot escape count\n- ``mandel_sum_native`` / ``mandel_sum`` opcode: grid sum in C\n- ``mandel_pixel`` opcode: one pixel escape count from float coords on stack\n- ``float_step_sum_native``: arithmetic series sum in C\n- ``int_step_sum_native``: integer arithmetic series sum in C\n";
/* #### Code section: decls ### */
static PyObject *__pyx_pf_5tests_14_stack_bench_c_ack_native(CYTHON_UNUSED PyObject *__pyx_self, int64_t __pyx_v_m, int64_t __pyx_v_n); /* proto */
static PyObject *__pyx_pf_5tests_14_stack_bench_c_2mandel_sum_native(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_width, int __pyx_v_height, int __pyx_v_max_iter); /* proto */
static PyObject *__pyx_pf_5tests_14_stack_bench_c_4int_step_sum_native(CYTHON_UNUSED PyObject *__pyx_self, int64_t __pyx_v_start, int64_t __pyx_v_stop, int64_t __pyx_v_step); /* proto */
static PyObject *__pyx_pf_5tests_14_stack_bench_c_6float_step_sum_native(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_start, double __pyx_v_stop, double __pyx_v_step); /* proto */
...
namespace {
  ...
  typedef struct {
    ...
    PyTypeObject *__pyx_ptype_7imgcomp_8_stack_c_OpHandler;
...
#define __pyx_kp_u_tests__stack_bench_c_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_ack __pyx_string_tab[11]
#define __pyx_n_u_ack_native __pyx_string_tab[12]
...
#define __pyx_n_u_float_step_sum_native __pyx_string_tab[16]
#define __pyx_n_u_height __pyx_string_tab[17]
#define __pyx_n_u_int __pyx_string_tab[18]
#define __pyx_n_u_int_step_sum_native __pyx_string_tab[19]
#define __pyx_n_u_items __pyx_string_tab[20]
#define __pyx_n_u_m __pyx_string_tab[21]
#define __pyx_n_u_mandel_pixel __pyx_string_tab[22]
#define __pyx_n_u_mandel_sum __pyx_string_tab[23]
#define __pyx_n_u_mandel_sum_native __pyx_string_tab[24]
...
#define __pyx_n_u_stop __pyx_string_tab[32]
#define __pyx_n_u_tests__stack_bench_c __pyx_string_tab[33]
#define __pyx_n_u_values __pyx_string_tab[34]
#define __pyx_n_u_width __pyx_string_tab[35]
#define __pyx_kp_b_double_void_int_double_int_int64 __pyx_string_tab[36]
#define __pyx_kp_b_iso88591_5_A __pyx_string_tab[37]
#define __pyx_kp_b_iso88591_a_q_xq __pyx_string_tab[38]
#define __pyx_kp_b_iso88591_EQ_1G6 __pyx_string_tab[39]
#define __pyx_kp_b_iso88591_Fa_q __pyx_string_tab[40]
...
static CYTHON_SMALL_CODE int __pyx_m_clear(PyObject *m) {
  ...
  #endif
  Py_CLEAR(clear_module_state->__pyx_ptype_7imgcomp_8_stack_c_OpHandler);
...
static CYTHON_SMALL_CODE int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_ptype_7imgcomp_8_stack_c_OpHandler);
...
static int64_t __pyx_f_5tests_14_stack_bench_c_ack_c(int64_t __pyx_v_m, int64_t __pyx_v_n) {
  int64_t __pyx_r;
  int __pyx_t_1;
  int64_t __pyx_t_2;
  int64_t __pyx_t_3;
 ...
 * 
*/
    __pyx_t_2 = __pyx_f_5tests_14_stack_bench_c_ack_c((__pyx_v_m - 1), 1); if (unlikely(__pyx_t_2 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L1_error)
    {
      __pyx_r = __pyx_t_2;
    }
    goto __pyx_L0;
 ...
 * 
*/
  __pyx_t_2 = __pyx_f_5tests_14_stack_bench_c_ack_c(__pyx_v_m, (__pyx_v_n - 1)); if (unlikely(__pyx_t_2 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
  __pyx_t_3 = __pyx_f_5tests_14_stack_bench_c_ack_c((__pyx_v_m - 1), __pyx_t_2); if (unlikely(__pyx_t_3 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L1_error)
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("tests._stack_bench_c.ack_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1L;
  __pyx_L0:;
...
static int64_t __pyx_f_5tests_14_stack_bench_c_mandel_escape_iters(double __pyx_v_x0, double __pyx_v_y0, int __pyx_v_max_iter) {
  double __pyx_v_zx;
  double __pyx_v_zy;
  int __pyx_v_it;
  double __pyx_v_mag2;
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_it < __pyx_v_max_iter);


    if (!__pyx_t_1) break;

    /* "tests/_stack_bench_c.pyx":47
 *     cdef double mag2
 *     while it < max_iter:
 *         mag2 = zx * zx + zy * zy             # <<<<<<<<<<<<<<
 *         if mag2 > 4.0:
 *             break
*/
    __pyx_v_mag2 = ((__pyx_v_zx * __pyx_v_zx) + (__pyx_v_zy * __pyx_v_zy));

    /* "tests/_stack_bench_c.pyx":48
 *     while it < max_iter:
 *         mag2 = zx * zx + zy * zy
 *         if mag2 > 4.0:             # <<<<<<<<<<<<<<
 *             break
...
*/
    __pyx_t_1 = (__pyx_v_mag2 > 4.0);

    if (__pyx_t_1) {


      /* "tests/_stack_bench_c.pyx":49
 *         mag2 = zx * zx + zy * zy
 *         if mag2 > 4.0:
 *             break             # <<<<<<<<<<<<<<
 *         zx, zy = zx * zx - zy * zy + x0, 2.0 * zx * zy + y0
 ...
 *     return it
*/
    __pyx_t_2 = (((__pyx_v_zx * __pyx_v_zx) - (__pyx_v_zy * __pyx_v_zy)) + __pyx_v_x0);

    __pyx_t_3 = (((2.0 * __pyx_v_zx) * __pyx_v_zy) + __pyx_v_y0);

    __pyx_v_zx = __pyx_t_2;
    __pyx_v_zy = __pyx_t_3;

    /* "tests/_stack_bench_c.pyx":51
 *             break
 *         zx, zy = zx * zx - zy * zy + x0, 2.0 * zx * zy + y0
 *         it += 1             # <<<<<<<<<<<<<<
 *     return it
...
static int64_t __pyx_f_5tests_14_stack_bench_c_mandel_sum_c(int __pyx_v_width, int __pyx_v_height, int __pyx_v_max_iter) {
...
*/
    __pyx_v_y0 = (-1.5 + ((((double)__pyx_v_py) * 2.0) / ((double)__pyx_v_height)));

    /* "tests/_stack_bench_c.pyx":64
 *     for py in range(height):
 *         y0 = (-1.5 + ((<double>py * 2.0) / <double>height))
 *         for px in range(width):             # <<<<<<<<<<<<<<
 *             x0 = (-2.0 + ((<double>px * 2.5) / <double>width))
 ...
 *     return total
*/
      __pyx_v_x0 = (-2.0 + ((((double)__pyx_v_px) * 2.5) / ((double)__pyx_v_width)));

      /* "tests/_stack_bench_c.pyx":66
 *         for px in range(width):
 *             x0 = (-2.0 + ((<double>px * 2.5) / <double>width))
 *             total += mandel_escape_iters(x0, y0, max_iter)             # <<<<<<<<<<<<<<
 *     return total
 * 
*/
      __pyx_t_7 = __pyx_f_5tests_14_stack_bench_c_mandel_escape_iters(__pyx_v_x0, __pyx_v_y0, __pyx_v_max_iter); if (unlikely(__pyx_t_7 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L1_error)
...
*/
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("tests._stack_bench_c.mandel_sum_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1L;
  __pyx_L0:;
...
static int64_t __pyx_f_5tests_14_stack_bench_c_int_step_sum_c(int64_t __pyx_v_start, int64_t __pyx_v_stop, int64_t __pyx_v_step) {
  int64_t __pyx_v_total;
  int64_t __pyx_v_value;
  int64_t __pyx_r;
  int __pyx_t_1;

  /* "tests/_stack_bench_c.pyx":72
 * cdef int64_t int_step_sum_c(int64_t start, int64_t stop, int64_t step):
 *     """Sum start, start+step, ... while value <= stop."""
 *     cdef int64_t total = 0             # <<<<<<<<<<<<<<
 ...
 *         total += value
*/
  __pyx_v_value = __pyx_v_start;

  /* "tests/_stack_bench_c.pyx":74
 *     cdef int64_t total = 0
 *     cdef int64_t value = start
 *     while value <= stop:             # <<<<<<<<<<<<<<
 *         total += value
...
*/
  while (1) {
    __pyx_t_1 = (__pyx_v_value <= __pyx_v_stop);


    if (!__pyx_t_1) break;

    /* "tests/_stack_bench_c.pyx":75
 *     cdef int64_t value = start
 *     while value <= stop:
 *         total += value             # <<<<<<<<<<<<<<
 *         value += step
 ...
 * 
*/
    __pyx_v_value = (__pyx_v_value + __pyx_v_step);
  }

  /* "tests/_stack_bench_c.pyx":77
 *         total += value
 *         value += step
 *     return total             # <<<<<<<<<<<<<<
 * 
...
static double __pyx_f_5tests_14_stack_bench_c_float_step_sum_c(double __pyx_v_start, double __pyx_v_stop, double __pyx_v_step) {
  double __pyx_v_total;
  double __pyx_v_value;
  double __pyx_r;
  int __pyx_t_1;

  /* "tests/_stack_bench_c.pyx":82
 * cdef double float_step_sum_c(double start, double stop, double step):
 *     """Sum start, start+step, ... while value <= stop."""
 *     cdef double total = 0.0             # <<<<<<<<<<<<<<
...
static int __pyx_f_5tests_14_stack_bench_c__op_ack(void) {
  int64_t __pyx_v_n;
  int64_t __pyx_v_m;
  int __pyx_r;
  int64_t __pyx_t_1;
...
*/
  __pyx_t_1 = __pyx_f_7imgcomp_8_stack_c_data_pop_int(); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 92, __pyx_L1_error)
  __pyx_v_n = __pyx_t_1;

  /* "tests/_stack_bench_c.pyx":93
 *     """Stack: m n -- result. Pop m then n; push Ackermann(m, n)."""
 *     cdef int64_t n = data_pop_int()
 *     cdef int64_t m = data_pop_int()             # <<<<<<<<<<<<<<
 *     data_push_int(ack_c(m, n))
 * 
*/
  __pyx_t_1 = __pyx_f_7imgcomp_8_stack_c_data_pop_int(); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 93, __pyx_L1_error)
  __pyx_v_m = __pyx_t_1;

  /* "tests/_stack_bench_c.pyx":94
 *     cdef int64_t n = data_pop_int()
 *     cdef int64_t m = data_pop_int()
 *     data_push_int(ack_c(m, n))             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_ack_c(__pyx_v_m, __pyx_v_n); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 94, __pyx_L1_error)
  __pyx_t_2 = __pyx_f_7imgcomp_8_stack_c_data_push_int(__pyx_t_1); if (unlikely(__pyx_t_2 == ((int)-1))) __PYX_ERR(0, 94, __pyx_L1_error)
...
*/
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("tests._stack_bench_c._op_ack", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
...
static int __pyx_f_5tests_14_stack_bench_c__op_mandel_pixel(void) {
...
*/
  __pyx_t_1 = __pyx_f_7imgcomp_8_stack_c_data_pop_int(); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 99, __pyx_L1_error)
  __pyx_v_max_iter = ((int)__pyx_t_1);


  /* "tests/_stack_bench_c.pyx":100
 *     """Stack: x0 y0 max_iter -- it. Pop max_iter, y0, x0; push escape count."""
 *     cdef int max_iter = <int>data_pop_int()
 *     cdef double y0 = data_pop_float()             # <<<<<<<<<<<<<<
 *     cdef double x0 = data_pop_float()
...
*/
  __pyx_t_2 = __pyx_f_7imgcomp_8_stack_c_data_pop_float(); if (unlikely(__PYX_CHECK_FLOAT_EXCEPTION(__pyx_t_2, ((double)(-1.0))) && PyErr_Occurred())) __PYX_ERR(0, 100, __pyx_L1_error)
  __pyx_v_y0 = __pyx_t_2;

  /* "tests/_stack_bench_c.pyx":101
 *     cdef int max_iter = <int>data_pop_int()
 *     cdef double y0 = data_pop_float()
 *     cdef double x0 = data_pop_float()             # <<<<<<<<<<<<<<
 *     data_push_int(mandel_escape_iters(x0, y0, max_iter))
 * 
*/
  __pyx_t_2 = __pyx_f_7imgcomp_8_stack_c_data_pop_float(); if (unlikely(__PYX_CHECK_FLOAT_EXCEPTION(__pyx_t_2, ((double)(-1.0))) && PyErr_Occurred())) __PYX_ERR(0, 101, __pyx_L1_error)
  __pyx_v_x0 = __pyx_t_2;

  /* "tests/_stack_bench_c.pyx":102
 *     cdef double y0 = data_pop_float()
 *     cdef double x0 = data_pop_float()
 *     data_push_int(mandel_escape_iters(x0, y0, max_iter))             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_mandel_escape_iters(__pyx_v_x0, __pyx_v_y0, __pyx_v_max_iter); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 102, __pyx_L1_error)
  __pyx_t_3 = __pyx_f_7imgcomp_8_stack_c_data_push_int(__pyx_t_1); if (unlikely(__pyx_t_3 == ((int)-1))) __PYX_ERR(0, 102, __pyx_L1_error)
...
*/
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("tests._stack_bench_c._op_mandel_pixel", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
...
static int __pyx_f_5tests_14_stack_bench_c__op_mandel_sum(void) {
  int __pyx_v_max_iter;
  int __pyx_v_height;
  int __pyx_v_width;
  int __pyx_r;
...
*/
  __pyx_t_1 = __pyx_f_7imgcomp_8_stack_c_data_pop_int(); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 107, __pyx_L1_error)
  __pyx_v_max_iter = ((int)__pyx_t_1);


  /* "tests/_stack_bench_c.pyx":108
 *     """Stack: width height max_iter -- total. Pop dims; push grid escape sum."""
 *     cdef int max_iter = <int>data_pop_int()
 *     cdef int height = <int>data_pop_int()             # <<<<<<<<<<<<<<
 *     cdef int width = <int>data_pop_int()
...
*/
  __pyx_t_1 = __pyx_f_7imgcomp_8_stack_c_data_pop_int(); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 108, __pyx_L1_error)
  __pyx_v_height = ((int)__pyx_t_1);


  /* "tests/_stack_bench_c.pyx":109
 *     cdef int max_iter = <int>data_pop_int()
 *     cdef int height = <int>data_pop_int()
 *     cdef int width = <int>data_pop_int()             # <<<<<<<<<<<<<<
 *     data_push_int(mandel_sum_c(width, height, max_iter))
 * 
*/
  __pyx_t_1 = __pyx_f_7imgcomp_8_stack_c_data_pop_int(); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 109, __pyx_L1_error)
  __pyx_v_width = ((int)__pyx_t_1);


  /* "tests/_stack_bench_c.pyx":110
 *     cdef int height = <int>data_pop_int()
 *     cdef int width = <int>data_pop_int()
 *     data_push_int(mandel_sum_c(width, height, max_iter))             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_mandel_sum_c(__pyx_v_width, __pyx_v_height, __pyx_v_max_iter); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 110, __pyx_L1_error)
  __pyx_t_2 = __pyx_f_7imgcomp_8_stack_c_data_push_int(__pyx_t_1); if (unlikely(__pyx_t_2 == ((int)-1))) __PYX_ERR(0, 110, __pyx_L1_error)
...
*/
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("tests._stack_bench_c._op_mandel_sum", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_5tests_14_stack_bench_c_1ack_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
...
PyDoc_STRVAR(__pyx_doc_5tests_14_stack_bench_c_ack_native, "Ackermann(m, n) in C without the stack VM.");
static PyMethodDef __pyx_mdef_5tests_14_stack_bench_c_1ack_native = {"ack_native", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5tests_14_stack_bench_c_1ack_native, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5tests_14_stack_bench_c_ack_native};
static PyObject *__pyx_pw_5tests_14_stack_bench_c_1ack_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("ack_native (wrapper)", 0);
  #if !CYTHON_VECTORCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "ack_native", 0) < (0)) __PYX_ERR(0, 119, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("ack_native", 1, 2, 2, i); __PYX_ERR(0, 119, __pyx_L3_error) }
      }
    ...
    __pyx_v_m = __Pyx_PyLong_As_int64_t(values[0]); if (unlikely((__pyx_v_m == ((int64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 119, __pyx_L3_error)
    __pyx_v_n = __Pyx_PyLong_As_int64_t(values[1]); if (unlikely((__pyx_v_n == ((int64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 119, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("ack_native", 1, 2, 2, __pyx_nargs); __PYX_ERR(0, 119, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __Pyx_AddTraceback("tests._stack_bench_c.ack_native", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5tests_14_stack_bench_c_ack_native(__pyx_self, __pyx_v_m, __pyx_v_n);
...
static PyObject *__pyx_pf_5tests_14_stack_bench_c_ack_native(CYTHON_UNUSED PyObject *__pyx_self, int64_t __pyx_v_m, int64_t __pyx_v_n) {
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("ack_native", 0);

  /* "tests/_stack_bench_c.pyx":121
 * def ack_native(int64_t m, int64_t n) -> int:
 *     """Ackermann(m, n) in C without the stack VM."""
 *     return ack_c(m, n)             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_ack_c(__pyx_v_m, __pyx_v_n); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 121, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyLong_From_int64_t(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 121, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);

  if (__Pyx_PyInt_FromNumber(&__pyx_t_2, NULL, 0) < (0)) __PYX_ERR(0, 121, __pyx_L1_error)
  {
    PyObject *__pyx_temp;
    {
      __pyx_temp = __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_5tests_14_stack_bench_c_3mandel_sum_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_5tests_14_stack_bench_c_2mandel_sum_native, "Sum Mandelbrot escape iterations over a grid in C without the stack VM.");
static PyMethodDef __pyx_mdef_5tests_14_stack_bench_c_3mandel_sum_native = {"mandel_sum_native", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5tests_14_stack_bench_c_3mandel_sum_native, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5tests_14_stack_bench_c_2mandel_sum_native};
static PyObject *__pyx_pw_5tests_14_stack_bench_c_3mandel_sum_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("mandel_sum_native (wrapper)", 0);
  #if !CYTHON_VECTORCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_width,&__pyx_mstate_global->__pyx_n_u_height,&__pyx_mstate_global->__pyx_n_u_max_iter,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "mandel_sum_native", 0) < (0)) __PYX_ERR(0, 124, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("mandel_sum_native", 1, 3, 3, i); __PYX_ERR(0, 124, __pyx_L3_error) }
      }
    ...
    __pyx_v_width = __Pyx_PyLong_As_int(values[0]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 124, __pyx_L3_error)
    __pyx_v_height = __Pyx_PyLong_As_int(values[1]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 124, __pyx_L3_error)
    __pyx_v_max_iter = __Pyx_PyLong_As_int(values[2]); if (unlikely((__pyx_v_max_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 124, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("mandel_sum_native", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 124, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("tests._stack_bench_c.mandel_sum_native", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5tests_14_stack_bench_c_2mandel_sum_native(__pyx_self, __pyx_v_width, __pyx_v_height, __pyx_v_max_iter);
...
static PyObject *__pyx_pf_5tests_14_stack_bench_c_2mandel_sum_native(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_width, int __pyx_v_height, int __pyx_v_max_iter) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int64_t __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("mandel_sum_native", 0);

  /* "tests/_stack_bench_c.pyx":126
 * def mandel_sum_native(int width, int height, int max_iter) -> int:
 *     """Sum Mandelbrot escape iterations over a grid in C without the stack VM."""
 *     return mandel_sum_c(width, height, max_iter)             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_mandel_sum_c(__pyx_v_width, __pyx_v_height, __pyx_v_max_iter); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 126, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyLong_From_int64_t(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 126, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);

  if (__Pyx_PyInt_FromNumber(&__pyx_t_2, NULL, 0) < (0)) __PYX_ERR(0, 126, __pyx_L1_error)
  {
    PyObject *__pyx_temp;
    {
      __pyx_temp = __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_5tests_14_stack_bench_c_5int_step_sum_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_5tests_14_stack_bench_c_4int_step_sum_native, "Sum start, start+step, ... while value <= stop in C without the stack VM.");
static PyMethodDef __pyx_mdef_5tests_14_stack_bench_c_5int_step_sum_native = {"int_step_sum_native", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5tests_14_stack_bench_c_5int_step_sum_native, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5tests_14_stack_bench_c_4int_step_sum_native};
static PyObject *__pyx_pw_5tests_14_stack_bench_c_5int_step_sum_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  int64_t __pyx_v_stop;
  int64_t __pyx_v_step;
  #if !CYTHON_VECTORCALL
  CYTHON_UNUSED Py_ssize_t __pyx_nargs;
  #endif
  CYTHON_UNUSED PyObject *const *__pyx_kwvalues;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("int_step_sum_native (wrapper)", 0);
  #if !CYTHON_VECTORCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_start,&__pyx_mstate_global->__pyx_n_u_stop,&__pyx_mstate_global->__pyx_n_u_step,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "int_step_sum_native", 0) < (0)) __PYX_ERR(0, 129, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("int_step_sum_native", 1, 3, 3, i); __PYX_ERR(0, 129, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 3)) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_start = __Pyx_PyLong_As_int64_t(values[0]); if (unlikely((__pyx_v_start == ((int64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_stop = __Pyx_PyLong_As_int64_t(values[1]); if (unlikely((__pyx_v_stop == ((int64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 129, __pyx_L3_error)
    __pyx_v_step = __Pyx_PyLong_As_int64_t(values[2]); if (unlikely((__pyx_v_step == ((int64_t)-1)) && PyErr_Occurred())) __PYX_ERR(0, 129, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("int_step_sum_native", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 129, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("tests._stack_bench_c.int_step_sum_native", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5tests_14_stack_bench_c_4int_step_sum_native(__pyx_self, __pyx_v_start, __pyx_v_stop, __pyx_v_step);
...
static PyObject *__pyx_pf_5tests_14_stack_bench_c_4int_step_sum_native(CYTHON_UNUSED PyObject *__pyx_self, int64_t __pyx_v_start, int64_t __pyx_v_stop, int64_t __pyx_v_step) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  int64_t __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("int_step_sum_native", 0);

  /* "tests/_stack_bench_c.pyx":131
 * def int_step_sum_native(int64_t start, int64_t stop, int64_t step) -> int:
 *     """Sum start, start+step, ... while value <= stop in C without the stack VM."""
 *     return int_step_sum_c(start, stop, step)             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_int_step_sum_c(__pyx_v_start, __pyx_v_stop, __pyx_v_step); if (unlikely(__pyx_t_1 == ((int64_t)-1L) && PyErr_Occurred())) __PYX_ERR(0, 131, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyLong_From_int64_t(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 131, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);

  if (__Pyx_PyInt_FromNumber(&__pyx_t_2, NULL, 0) < (0)) __PYX_ERR(0, 131, __pyx_L1_error)
  {
    PyObject *__pyx_temp;
    {
      __pyx_temp = __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_5tests_14_stack_bench_c_7float_step_sum_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyDoc_STRVAR(__pyx_doc_5tests_14_stack_bench_c_6float_step_sum_native, "Sum start, start+step, ... while value <= stop in C without the stack VM.");
static PyMethodDef __pyx_mdef_5tests_14_stack_bench_c_7float_step_sum_native = {"float_step_sum_native", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5tests_14_stack_bench_c_7float_step_sum_native, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5tests_14_stack_bench_c_6float_step_sum_native};
static PyObject *__pyx_pw_5tests_14_stack_bench_c_7float_step_sum_native(PyObject *__pyx_self, 
#if CYTHON_VECTORCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("float_step_sum_native (wrapper)", 0);
  #if !CYTHON_VECTORCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  __pyx_nargs = PyTuple_GET_SIZE(__pyx_args);
  #else
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "float_step_sum_native", 0) < (0)) __PYX_ERR(0, 134, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 3; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("float_step_sum_native", 1, 3, 3, i); __PYX_ERR(0, 134, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 3)) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_start = __Pyx_PyFloat_AsDouble(values[0]); if (unlikely((__pyx_v_start == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 134, __pyx_L3_error)
    __pyx_v_stop = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_stop == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 134, __pyx_L3_error)
    __pyx_v_step = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_step == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 134, __pyx_L3_error)
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("float_step_sum_native", 1, 3, 3, __pyx_nargs); __PYX_ERR(0, 134, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  __Pyx_AddTraceback("tests._stack_bench_c.float_step_sum_native", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5tests_14_stack_bench_c_6float_step_sum_native(__pyx_self, __pyx_v_start, __pyx_v_stop, __pyx_v_step);
...
static PyObject *__pyx_pf_5tests_14_stack_bench_c_6float_step_sum_native(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_start, double __pyx_v_stop, double __pyx_v_step) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("float_step_sum_native", 0);

  /* "tests/_stack_bench_c.pyx":136
 * def float_step_sum_native(double start, double stop, double step) -> float:
 *     """Sum start, start+step, ... while value <= stop in C without the stack VM."""
 *     return float_step_sum_c(start, stop, step)             # <<<<<<<<<<<<<<
*/
  __pyx_t_1 = __pyx_f_5tests_14_stack_bench_c_float_step_sum_c(__pyx_v_start, __pyx_v_stop, __pyx_v_step); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 136, __pyx_L1_error)
...
static int __Pyx_modinit_Type_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Type import code ---*/
  __pyx_t_1 = PyImport_ImportModule("imgcomp._stack_c"); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_mstate->__pyx_ptype_7imgcomp_8_stack_c_OpHandler = __Pyx_ImportType_3_3_0(__pyx_t_1, "imgcomp._stack_c", "OpHandler",
  #if defined(PYPY_VERSION_NUM) && PYPY_VERSION_NUM < 0x050B0000
  sizeof(struct __pyx_obj_7imgcomp_8_stack_c_OpHandler), __PYX_GET_STRUCT_ALIGNMENT_3_3_0(struct __pyx_obj_7imgcomp_8_stack_c_OpHandler),
  #elif CYTHON_COMPILING_IN_LIMITED_API
  sizeof(struct __pyx_obj_7imgcomp_8_stack_c_OpHandler), __PYX_GET_STRUCT_ALIGNMENT_3_3_0(struct __pyx_obj_7imgcomp_8_stack_c_OpHandler),
  #else
  sizeof(struct __pyx_obj_7imgcomp_8_stack_c_OpHandler), __PYX_GET_STRUCT_ALIGNMENT_3_3_0(struct __pyx_obj_7imgcomp_8_stack_c_OpHandler),
  #endif
  __Pyx_ImportType_CheckSize_Warn_3_3_0); if (!__pyx_mstate->__pyx_ptype_7imgcomp_8_stack_c_OpHandler) __PYX_ERR(1, 8, __pyx_L1_error)
...
static int __Pyx_modinit_Function_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    __pyx_t_1 = PyImport_ImportModule("imgcomp._stack_c"); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    const char * __pyx_import_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_double_void_int_double_int_int64);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_import_signature)) __PYX_ERR(0, 1, __pyx_L1_error)
    #endif
    const char * __pyx_import_name = __pyx_import_signature + 140;
    void (**const __pyx_import_pointers[])(void) = {(void (**)(void))&__pyx_f_7imgcomp_8_stack_c_data_pop_float, (void (**)(void))&__pyx_f_7imgcomp_8_stack_c_data_push_float, (void (**)(void))&__pyx_f_7imgcomp_8_stack_c_data_push_int, (void (**)(void))&__pyx_f_7imgcomp_8_stack_c_data_pop_int, (void (**)(void))&__pyx_f_7imgcomp_8_stack_c__handler, (void (**)(void)) NULL};
...
static int __pyx_pymod_exec__stack_bench_c(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__stack_bench_c},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
namespace {
  ...
  #endif
  {
      ...
      "_stack_bench_c",
      __pyx_k_Test_only_C_kernels_and_VM_op_ha, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
...
__Pyx_PyMODINIT_FUNC PyInit__stack_bench_c(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__stack_bench_c(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__stack_bench_c(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_stack_bench_c' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "_stack_bench_c" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit__stack_bench_c", 0);
  ...
  if (__pyx_module_is_main_tests___stack_bench_c) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "tests._stack_bench_c")) {
      if (unlikely((PyDict_SetItemString(modules, "tests._stack_bench_c", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  __pyx_t_2 = ((PyObject *)__pyx_f_7imgcomp_8_stack_c__handler(__pyx_f_5tests_14_stack_bench_c__op_ack)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ack, __pyx_t_2) < (0)) __PYX_ERR(0, 114, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "tests/_stack_bench_c.pyx":115
 * # VM opcode tokens for register_op("ack", ack), etc.
 * ack = _handler(_op_ack)
 * mandel_pixel = _handler(_op_mandel_pixel)             # <<<<<<<<<<<<<<
 * mandel_sum = _handler(_op_mandel_sum)
 * 
*/
  __pyx_t_2 = ((PyObject *)__pyx_f_7imgcomp_8_stack_c__handler(__pyx_f_5tests_14_stack_bench_c__op_mandel_pixel)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 115, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_mandel_pixel, __pyx_t_2) < (0)) __PYX_ERR(0, 115, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "tests/_stack_bench_c.pyx":116
 * ack = _handler(_op_ack)
 * mandel_pixel = _handler(_op_mandel_pixel)
 * mandel_sum = _handler(_op_mandel_sum)             # <<<<<<<<<<<<<<
 * 
 * 
*/
  __pyx_t_2 = ((PyObject *)__pyx_f_7imgcomp_8_stack_c__handler(__pyx_f_5tests_14_stack_bench_c__op_mandel_sum)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 116, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_mandel_sum, __pyx_t_2) < (0)) __PYX_ERR(0, 116, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_5tests_14_stack_bench_c_1ack_native, 0, __pyx_mstate_global->__pyx_n_u_ack_native, NULL, __pyx_mstate_global->__pyx_n_u_tests__stack_bench_c, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 119, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ack_native, __pyx_t_3) < (0)) __PYX_ERR(0, 119, __pyx_L1_error)
...
*/
  ...
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_5tests_14_stack_bench_c_3mandel_sum_native, 0, __pyx_mstate_global->__pyx_n_u_mandel_sum_native, NULL, __pyx_mstate_global->__pyx_n_u_tests__stack_bench_c, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_mandel_sum_native, __pyx_t_2) < (0)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 129, __pyx_L1_error)
  __pyx_t_3 = __Pyx_CyFunction_New(&__pyx_mdef_5tests_14_stack_bench_c_5int_step_sum_native, 0, __pyx_mstate_global->__pyx_n_u_int_step_sum_native, NULL, __pyx_mstate_global->__pyx_n_u_tests__stack_bench_c, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[2])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_3);
  #endif
  __Pyx_CyFunction_SetAnnotationsDict(__pyx_t_3, __pyx_t_2);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_int_step_sum_native, __pyx_t_3) < (0)) __PYX_ERR(0, 129, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_n_u_float) < (0)) __PYX_ERR(0, 134, __pyx_L1_error)
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_5tests_14_stack_bench_c_7float_step_sum_native, 0, __pyx_mstate_global->__pyx_n_u_float_step_sum_native, NULL, __pyx_mstate_global->__pyx_n_u_tests__stack_bench_c, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[3])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  __Pyx_CyFunction_SetAnnotationsDict(__pyx_t_2, __pyx_t_3);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_float_step_sum_native, __pyx_t_2) < (0)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "tests/_stack_bench_c.pyx":1
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init tests._stack_bench_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init tests._stack_bench_c");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  ...
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } str_length_index[] = {{1},{24},{20},{12},{8},{8},{10},{8},{12},{8},{13},{3},{10},{18},{18},{5},{21},{6},{3},{19},{5},{1},{12},{10},{17},{8},{1},{3},{6},{10},{5},{4},{4},{20},{6},{5}};
    const struct { const unsigned int length: 8; } bytes_length_index[] = {{206},{16},{18},{19},{18}};
    #ifndef CYTHON_COMPRESS_STRINGS
      #define CYTHON_COMPRESS_STRINGS 0
    #endif
    #if (CYTHON_COMPRESS_STRINGS) == 1 /* compression: zlib (388 bytes) */
static const char cstring[] = "x\332mQ\275n\024A\014\336HH)REHi\322\\\307%\305EH$P\240 $\022\250 \360\002\226o\326\233\035\230\277\333\361\034{o@y\345\226W\346\021R\346\021\366\021x\224x\3666D\001F#\333\337\370\263?\313\363\216)r<\201\310\250~\300\234\234\252A\315\302\252\005\270\022s\265\372\240\025\303gj\371\033U\000\350\234gd\0029Ur*{\213\332\r\336\227\311\014\031\207v\360\213\204\346!\316:\342t\004\345\033\237X;\022\305,\352\220\365\2220\256\234\322~\366\047\033\225\021\013\322\233\033T4\027je<\362`d^\n\020\223\035\253k\322\327\265T\345\373wN3\331h-\272\222\014\004\335\222\031c\241<F#\331b\013R\320\270\340CC\234\032\027\211K\2520\031\226\0355\234\233G\366a\330\333\354\351\336\226h\022\305\237\272\344\272\364inh2]z]\036\0252\325d\272}\032\201\230\263W\300\003\312\301\0033r\223\024O\000\362\027\370\371wx\255\355\265\3626\300\233QK\301\227\360I\3066\324L\216\247[\"\377\217\346\003T.K\224\310\010!\303\274\272\021\246X\377\203e\226Gr\006Po\205\372bz\263\363\373\331\336\257\323\365\316\372\371\372}_\234\337b\306o\327\213n\267k7\213\276\270\270\373*/\375\336a\367\262\373\2709\273\331\357\213\313\273\201t\336\355w/6\007\233\305=\006z\363&";
...
static const char bytes[] = "?tests/_stack_bench_c.pyx__Pyx_PyDict_NextRef__annotate____func____main____module____name____qualname____test___is_coroutineackack_nativeasyncio.coroutinescline_in_tracebackfloatfloat_step_sum_nativeheightintint_step_sum_nativeitemsmmandel_pixelmandel_summandel_sum_nativemax_iternpopreturnsetdefaultstartstepstoptests._stack_bench_cvalueswidthdouble (void)\000int (double)\000int (int64_t)\000int64_t (void)\000struct __pyx_obj_7imgcomp_8_stack_c_OpHandler *(__pyx_t_7imgcomp_8_stack_c_op_fn_t)\000data_pop_float\000data_push_float\000data_push_int\000data_pop_int\000_handler\320\000(\250\001\340\004\013\2105\220\001\220\023\220A\320\000>\270a\340\004\013\210<\220q\230\007\230x\240q\320\000E\300Q\340\004\013\320\013\033\2301\230G\2406\250\021\320\000F\300a\340\004\013\210>\230\021\230\047\240\026\240q";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_m, __pyx_mstate->__pyx_n_u_n};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_tests__stack_bench_c_pyx, __pyx_mstate->__pyx_n_u_ack_native, __pyx_mstate->__pyx_kp_b_iso88591_5_A, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 124};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_width, __pyx_mstate->__pyx_n_u_height, __pyx_mstate->__pyx_n_u_max_iter};
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_tests__stack_bench_c_pyx, __pyx_mstate->__pyx_n_u_mandel_sum_native, __pyx_mstate->__pyx_kp_b_iso88591_a_q_xq, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 129};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_start, __pyx_mstate->__pyx_n_u_stop, __pyx_mstate->__pyx_n_u_step};
    __pyx_mstate_global->__pyx_codeobj_tab[2] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_tests__stack_bench_c_pyx, __pyx_mstate->__pyx_n_u_int_step_sum_native, __pyx_mstate->__pyx_kp_b_iso88591_Fa_q, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[2])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {3, 0, 0, 3, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 134};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_start, __pyx_mstate->__pyx_n_u_stop, __pyx_mstate->__pyx_n_u_step};
    __pyx_mstate_global->__pyx_codeobj_tab[3] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_tests__stack_bench_c_pyx, __pyx_mstate->__pyx_n_u_float_step_sum_native, __pyx_mstate->__pyx_kp_b_iso88591_EQ_1G6, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[3])) goto bad;
  }
