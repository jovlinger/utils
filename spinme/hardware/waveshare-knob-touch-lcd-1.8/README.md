...
Board-local research for the Waveshare dual-MCU knob + 1.8" round touch LCD.
Sibling hardware under `../elecrow-crowpanel-1.28/` is a separate Elecrow CrowPanel unit.
...
| **Display** | 1.8" IPS 360x360, QSPI, driver ST77916; touch CST816 (I2C) |
...
- **Q: Display IC and interface?**  
  **A:** ST77916, 360x360, QSPI. Arduino demo pins (S3): CS=14, PCLK=13, DATA0-3=15,16,17,18, RST=21, Backlight=47. Touch: CST816 (I2C).

- **Q: LVGL rotation?**  
  **A:** 180 deg is fast (pixel reversal in flush). 90 deg/270 deg need matrix transpose and are slow on S3; MADCTL (esp_lcd) may allow hardware rotation  --  worth trying (Reddit).
